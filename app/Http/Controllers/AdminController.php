...
class AdminController extends Controller
{
    ...
    public function deleteComplaint($complaint_id)
    {
        ...
        if($deleteComplaint) {
            Session::flash('deleteComplaint','Data Deleted Successfully');
    ...
    public function submitUpdateOrder(Request $request, $schedule_id)
    {
        ...
        if ($updateOrder) {
            Session::flash('status', 'Data Order Berhasil Diperbarui');
            return redirect('manage-order');
        } else {
            Session::flash('notSetDataMessage', 'Data Order Gagal Diperbarui');
            return view('admin.update-order', compact('updateOrder'));
        }
    }
    ...
    public function historyAllReedemPoint()
    {
        $data['history'] = RedeemPoint::select("redeem_points.*",'user.name')
                            ...
                            ->get();
        return view('admin.redeem-point-history',$data);
    }
    ...
    public function submitAddArticle(Request $request)
    {
        ...
        $path = $request->file('image_article')->store('public');
